...
namespace SL_WCF.CRUD
{
    ...
    public class Usuario : IUsuario
    {
        ...
        public SL_WCF.CRUD.Result Add(ML.Usuario usuario)
        {
            ML.Result result = BL.Usuario.Add(usuario);
            return new SL_WCF.CRUD.Result
            {
        ...
        public SL_WCF.CRUD.Result Delete(int idUsuario)
        {
        ...
        public SL_WCF.CRUD.Result Update(ML.Usuario usuario)
        {
        ...
        public SL_WCF.CRUD.Result GetAll(ML.Usuario usuarioObj)
        {
